...
mkdir -p /var/lib/jenkins/workspace/venv

# Create and activate a virtual environment
python3 -m venv /var/lib/jenkins/workspace/venv
source /var/lib/jenkins/workspace/venv/bin/activate

# Install application dependencies
pip install -r /var/lib/jenkins/workspace/test/app/requirements.txt

# Run the Python application (make sure the script name is correct)
python /var/lib/jenkins/workspace/test/app/main.py
...
# # Your existing script commands continue here...
...
# # =====================
# # FIX: Python Installation & Virtual Environment
# # =====================
